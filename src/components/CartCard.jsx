      ...
      <div>
        ...
        <div className="flex_cart">
          ...
          {prop.quantity + 1 > prop.q_max ? (
            <>
              <button className="button_cart">+</button>
              <br />
              <p className="max_quantity_message">
                {" "}
        ...
        <button
          ...
          onClick={() => EliminateArticle(prop.id)}
        >
